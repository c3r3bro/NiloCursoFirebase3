package com.example.nilocursofirebase.detail
...
import com.example.nilocursofirebase.databinding.FragmentDetailBinding
...
class DetailFragment : Fragment() {
    ...
    private fun getProduct() {
        product = (activity as? MainAux)?.gerProductSelected()
        product?.let { product ->
            binding?.let {
    ...
    private fun addToCart(product: Product){
        (activity as? MainAux)?.let {
            ...
            activity?.onBackPressed()//finalizar el fragment
        }
    }
